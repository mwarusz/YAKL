...
int main(int argc, char* argv[]) {
  ...
  yakl::init();
  {
    ...
    // This block is the writing phase
    {
      ...
      Array<signed        char,1,yakl::memDevice,styleC      > a0("a0",d1);
      Array<unsigned      char,2,yakl::memDevice,styleFortran> a1("a1",d1,d2);
      Array<             short,3,yakl::memDevice,styleC      > a2("a2",d3,d2,d1);
      Array<unsigned     short,4,yakl::memDevice,styleFortran> a3("a3",d1,d2,d3,d4);
      Array<               int,5,yakl::memDevice,styleC      > a4("a4",d5,d4,d3,d2,d1);
      Array<unsigned       int,6,yakl::memHost  ,styleFortran> a5("a5",d1,d2,d3,d4,d5,d6);
      //Array<         long long,7,yakl::memHost  ,styleC      > a6("a6",d7,d6,d5,d4,d3,d2,d1);
      //Array<unsigned long long,8,yakl::memHost  ,styleFortran> a7("a7",d1,d2,d3,d4,d5,d6,d7,d8);
      Array<             float,3,yakl::memHost  ,styleC      > a8("a8",d3,d2,d1);
      Array<            double,3,yakl::memHost  ,styleFortran> a9("a9",d1,d2,d3);
      Array<              char,2,yakl::memHost  ,styleC      > text("text",4,10);
      Array<               int,1,yakl::memHost  ,styleC      > bool8("bool8",d8);
      float s0 = 1;
      int   s1 = 2;
    ...
    // This block is the reading phase
    {
      ...
      Array<signed        char,1,yakl::memDevice,styleC      > a0("a0",d1);
      Array<unsigned      char,2,yakl::memHost  ,styleC      > a1("a1",d2,d1);
      Array<             short,3,yakl::memDevice,styleC      > a2("a2",d3,d2,d1);
      Array<unsigned     short,4,yakl::memHost  ,styleC      > a3("a3",d4,d3,d2,d1);
      Array<               int,5,yakl::memDevice,styleC      > a4("a4",d5,d4,d3,d2,d1);
      Array<unsigned       int,6,yakl::memHost  ,styleFortran> a5("a5",d1,d2,d3,d4,d5,d6);
      //Array<         long long,7,yakl::memDevice,styleFortran> a6("a6",d1,d2,d3,d4,d5,d6,d7);
      //Array<unsigned long long,8,yakl::memHost  ,styleFortran> a7("a7",d1,d2,d3,d4,d5,d6,d7,d8);
      Array<             float,3,yakl::memDevice,styleFortran> a8("a8",d1,d2,d3);
      Array<            double,3,yakl::memHost  ,styleFortran> a9("a9",d1,d2,d3);
      Array<signed        char,2,yakl::memDevice,styleC      > a0_unlim("a0_unlim",num_entries,d1);
      Array<unsigned      char,3,yakl::memHost  ,styleC      > a1_unlim("a1_unlim",num_entries,d2,d1);
      Array<             short,4,yakl::memDevice,styleC      > a2_unlim("a2_unlim",num_entries,d3,d2,d1);
      Array<unsigned     short,5,yakl::memHost  ,styleC      > a3_unlim("a3_unlim",num_entries,d4,d3,d2,d1);
      Array<               int,6,yakl::memDevice,styleC      > a4_unlim("a4_unlim",num_entries,d5,d4,d3,d2,d1);
      //Array<unsigned       int,7,yakl::memHost  ,styleFortran> a5_unlim("a5_unlim",d1,d2,d3,d4,d5,d6,num_entries);
      //Array<         long long,8,yakl::memDevice,styleFortran> a6_unlim("a6_unlim",d1,d2,d3,d4,d5,d6,d7,num_entries);
      Array<             float,4,yakl::memDevice,styleFortran> a8_unlim("a8_unlim",d1,d2,d3,num_entries);
      Array<            double,4,yakl::memHost  ,styleFortran> a9_unlim("a9_unlim",d1,d2,d3,num_entries);
      Array<              char,2,yakl::memHost  ,styleC      > text("text",4,10);
      Array<              bool,1,yakl::memHost  ,styleC      > bool8("bool8",d8);
      Array<float,1,yakl::memHost  ,styleC> s0_unlim("s0_unlim",num_entries);
      Array<int  ,1,yakl::memDevice,styleC> s1_unlim("s1_unlim",num_entries);
      float s0;
      int   s1;
