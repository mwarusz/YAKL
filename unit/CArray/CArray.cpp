...
int main(int argc, char* argv[]) {
  ...
  yakl::init();
  {
    ...
    */
    ...
    ///////////////////////////////////////////////////////////
    yakl::memset(test6d,0.f);
    auto slice = test6d.slice<3>(1,2,3,COLON,COLON,COLON);
    yakl::memset(slice,1.f);
    if (yakl::intrinsics::sum(test6d) != d4*d5*d6) { die("slice: wrong sum for slice"); }
    ...
    */
    ...
    // Test reshape
    ///////////////////////////////////////////////////////////
    auto reshaped = test6d.reshape<3>({20,16,1134});
    memset(reshaped,2.f);
    ...
    // Test collapse
    ///////////////////////////////////////////////////////////
    auto collapsed = test6d.collapse();
